...
var expressPort = getNumberOption_1.default(
  lodash_1.defaultTo(process.env.EXPRESS_PORT, process.env.PORT),
...
var defaultMongoUrl = process.env.MONGODB_ADDON_URI;
var mongoUrl = getStringOption_1.default(process.env.MONGODB_ADDON_URI, defaultMongoUrl);
...
exports.default = {
  ...
  express: {
    ...
    allowUndefinedMethod: getBooleanOption_1.default(
  ...
  googleStorageRepo: {
    ...
    keyFileName: getStringOption_1.default(
  ...
  mongoModelsRepo: {
    dbName: getStringOption_1.default(
      process.env.MONGODB_ADDON_DB,
      getDbFromUrl_1.default(mongoUrl),
    ),
  ...
  s3StorageRepo: {
    awsConfig: {
      ...
      tls: true,
      credentials: {
        accessKeyId: getStringOption_1.default(
          process.env.CELLAR_ADDON_KEY_ID,
          globalAwsIamAccessKeyId,
        ),
        secretAccessKey: getStringOption_1.default(
          process.env.CELLAR_ADDON_KEY_SECRET,
          globalAwsIamAccessKeySecret,
        ),
      },
    },
    bucketName: getStringOption_1.default(process.env.CELLAR_ADDON_BUCKET, 'xapi-storage'),
  },
  statementsService: {
    awaitUpdates: getBooleanOption_1.default(
      lodash_1.defaultTo(process.env.SERVICE_AWAIT_UPDATES, process.env.SERVICE_AWAIT_UODATES),
      false,
    ),
    enableActorLowerCasing: getBooleanOption_1.default(
      process.env.STATEMENTS_SERVICE_LOWERCASE_ACTORS,
      false,
    ),
    enableActivityUpdates: getBooleanOption_1.default(
      process.env.STATEMENTS_SERVICE_UPDATE_ACTIVITIES,
    ),
    enableAttachmentCreation: getBooleanOption_1.default(
      process.env.STATEMENTS_SERVICE_CREATE_ATTACHMENTS,
    ),
    enableAttachmentValidation: getBooleanOption_1.default(
      process.env.STATEMENTS_SERVICE_CHECK_ATTACHMENTS,
    ),
    enableConflictChecks: getBooleanOption_1.default(
    ...
    enableStatementCreation: getBooleanOption_1.default(
  ...
  winston: {
    cloudWatch: {
      ...
      logGroupName: getStringOption_1.default(
        process.env.WINSTON_CLOUDWATCH_LOG_GROUP_NAME,
        'xapi-service',
      ),
      logStreamName: getStringOption_1.default(
