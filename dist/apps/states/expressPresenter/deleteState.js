...
var deleteWithService_1 = __importDefault(require("./utils/deleteWithService"));
exports.default = (function (config) {
    return catchErrors_1.default(config, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            query = req.query;
            headers = req.headers;
            return [2 /*return*/, deleteWithService_1.default({ config: config, res: res, query: query, headers: headers })];
        });
    }); });
});
