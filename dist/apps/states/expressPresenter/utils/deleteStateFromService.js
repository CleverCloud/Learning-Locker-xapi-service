...
exports.default = (function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var client, activityId, agent, registration, stateId;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, config.service.deleteState({ activityId: activityId, agent: agent, client: client, stateId: stateId, registration: registration })];
                case 2:
                    _b.sent();
...
//# sourceMappingURL=deleteStateFromService.js.map