...
var deleteWithService_1 = __importDefault(require("./deleteWithService"));
var getWithService_1 = __importDefault(require("./getWithService"));
var overwriteStateWithService_1 = __importDefault(require("./overwriteStateWithService"));
var patchStateWithService_1 = __importDefault(require("./patchStateWithService"));
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    content = stringToStream_1.stringToStream(lodash_1.get(query, 'content', ''));
                    return [2 /*return*/, patchStateWithService_1.default({ query: query, headers: headers, content: content, config: config, res: res })];
                ...
                case 6:
                    ...
                    headers = getHeaders(query, req);
                    content = stringToStream_1.stringToStream(lodash_1.get(query, 'content', ''));
                    return [2 /*return*/, overwriteStateWithService_1.default({ query: query, headers: headers, content: content, config: config, res: res })];
                case 7: return [4 /*yield*/, getQuery(req)];
                case 8:
                    query = _c.sent();
                    headers = getHeaders(query, req);
                    return [2 /*return*/, deleteWithService_1.default({ config: config, headers: headers, query: query, res: res })];
                case 9:
                    {
