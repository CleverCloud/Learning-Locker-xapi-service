...
describe('expressPresenter.getStates with existing model', function () {
    setup_1.default();
    it('should 400 without version header', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default({}, false).expect(http_status_codes_1.StatusCodes.BAD_REQUEST)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should return state ids when getting a existing model', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default().expect(http_status_codes_1.StatusCodes.OK, [testValues_1.TEST_STATE_ID])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should return state ids when not using registration', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default({ registration: undefined }).expect(http_status_codes_1.StatusCodes.OK, [testValues_1.TEST_STATE_ID])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should return no ids when getting existing model without a registration with one', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default().expect(http_status_codes_1.StatusCodes.OK, [])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should return state ids when using an mbox', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOX_AGENT) }).expect(http_status_codes_1.StatusCodes.OK, [
                            testValues_1.TEST_STATE_ID,
                        ])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should return state ids when using an mbox_sha1sum', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOXSHA1_AGENT) }).expect(http_status_codes_1.StatusCodes.OK, [
                            testValues_1.TEST_STATE_ID,
                        ])];
                case 2:
                    _a.sent();
    ...
    it('should return state ids when using an openid', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default({ agent: JSON.stringify(testValues_1.TEST_OPENID_AGENT) }).expect(http_status_codes_1.StatusCodes.OK, [
                            testValues_1.TEST_STATE_ID,
                        ])];
                case 2:
                    _a.sent();
    ...
    it('should return state ids when using an account', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, getStates_1.default({ agent: JSON.stringify(testValues_1.TEST_ACCOUNT_AGENT) }).expect(http_status_codes_1.StatusCodes.OK, [
                            testValues_1.TEST_STATE_ID,
                        ])];
                case 2:
                    _a.sent();
...
//# sourceMappingURL=getExistingStates.test.js.map