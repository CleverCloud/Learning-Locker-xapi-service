...
var deleteStates_1 = __importDefault(require("./utils/deleteStates"));
describe('expressPresenter.deleteStates with existing state', function () {
    setup_1.default();
    it('should delete when deleting text', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default().expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 2:
                    _a.sent();
    ...
    it('should delete when not using registration', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default({
    ...
    it('should error when deleting existing model without a registration with one', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createImmutableState_1.default({ registration: undefined })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default().expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, assertImmutableState_1.default({ registration: undefined }, { registration: undefined })];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should delete when deleting with an mbox', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOX_AGENT) }).expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an mbox_sha1sum', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default({ agent: JSON.stringify(testValues_1.TEST_MBOXSHA1_AGENT) }).expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an openid', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default({ agent: JSON.stringify(testValues_1.TEST_OPENID_AGENT) }).expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an account', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteStates_1.default({ agent: JSON.stringify(testValues_1.TEST_ACCOUNT_AGENT) }).expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 2:
                    _a.sent();
