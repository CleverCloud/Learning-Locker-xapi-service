        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    timestamp = new Date();
                    return [4 /*yield*/, getTestStates_1.default({ since: timestamp.toISOString() })];
                case 3:
    ...
    it('should return the state id when updated after since', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    getStatesResult = _a.sent();
                    assert.deepStrictEqual(getStatesResult.stateIds, [testValues_1.TEST_STATE_ID]);
                    return [2 /*return*/];
            }
        });
    }); });
