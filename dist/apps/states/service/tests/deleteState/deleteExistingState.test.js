...
describe('deleteState with existing state', function () {
    setup_1.default();
    ...
    it('should delete when deleting without registration', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ registration: undefined })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, assertDeleted_1.default()];
                case 3:
    ...
    it('should delete when deleting with an mbox', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: testValues_1.TEST_MBOX_AGENT })];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an mbox_sha1sum', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: testValues_1.TEST_MBOXSHA1_AGENT })];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an openid', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: testValues_1.TEST_OPENID_AGENT })];
                case 2:
                    _a.sent();
    ...
    it('should delete when deleting with an account', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, deleteState_1.default({ agent: testValues_1.TEST_ACCOUNT_AGENT })];
                case 2:
                    _a.sent();
