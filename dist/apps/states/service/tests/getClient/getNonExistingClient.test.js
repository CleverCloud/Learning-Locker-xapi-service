...
var Unauthorised_1 = __importDefault(require("jscommons/dist/errors/Unauthorised"));
...
describe('getClient using non-existing model', function () {
    ...
    it('should error when getting without clients', function () { return __awaiter(void 0, void 0, void 0, function () {
        var promise;
