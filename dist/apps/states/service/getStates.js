...
var validateSince_1 = __importDefault(require("./utils/validateSince"));
var getSince = function (since) {
    if (since !== undefined) {
        validateSince_1.default(since);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    since = getSince(opts.since);
                    return [4 /*yield*/, config.repo.getStates({
