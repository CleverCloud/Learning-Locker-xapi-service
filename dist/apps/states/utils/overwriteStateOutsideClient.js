...
exports.default = (function (client) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, testService_1.default.overwriteState({
                    activityId: testValues_1.TEST_ACTIVITY_ID,
                    agent: testValues_1.TEST_MBOX_AGENT,
                    client: client,
                    content: stringToStream_1.stringToStream(testValues_1.TEST_CONTENT),
...
//# sourceMappingURL=overwriteStateOutsideClient.js.map