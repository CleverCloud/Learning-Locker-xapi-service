...
exports.default = (function (config) {
    return function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var collection, stateFilter, update, createOpResult, id, opResult;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, config.db()];
                case 1:
                    collection = (_c.sent()).collection(constants_1.COLLECTION_NAME);
                ...
                case 2:
                    ...
                    id = ((_a = createOpResult.lastErrorObject) === null || _a === void 0 ? void 0 : _a.upserted) || ((_b = createOpResult.value) === null || _b === void 0 ? void 0 : _b._id);
