...
exports.default = (function (config) {
    return function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var collection, stateFilter, stateDocuments, ids, deletedStates;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    ids = stateDocuments.map(function (state) {
                        return state._id;
                    });
                    return [4 /*yield*/, collection.deleteMany({ _id: { $in: ids } }, {})];
                case 3:
                    _a.sent();
                    ...
                    return [2 /*return*/, { states: deletedStates }];
            }
        });
    }); };
});
