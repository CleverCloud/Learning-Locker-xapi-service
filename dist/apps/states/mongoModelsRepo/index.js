...
exports.default = (function (config) {
    return {
        ...
        deleteState: deleteState_1.default(config),
        deleteStates: deleteStates_1.default(config),
        getState: getState_1.default(config),
        getStates: getStates_1.default(config),
        migrate: function () { return Promise.resolve(); },
        overwriteState: overwriteState_1.default(config),
        patchState: patchState_1.default(config),
