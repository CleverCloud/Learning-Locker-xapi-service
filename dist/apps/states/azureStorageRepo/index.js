...
var clearRepo_1 = __importDefault(require("./clearRepo"));
...
exports.default = (function (config) {
    return {
        ...
        deleteStateContent: deleteStateContent_1.default(config),
        deleteStatesContent: deleteStatesContent_1.default(config),
        getStateContent: getStateContent_1.default(config),
        ...
        storeStateContent: storeStateContent_1.default(config),
    };
});
