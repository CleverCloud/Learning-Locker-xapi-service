...
var getStatementsResult_1 = __importDefault(require("./utils/getStatementsResult"));
var getLimit = function (val) {
    var defaultLimit = 100;
    var limit = getNumberOption_1.default(val, defaultLimit);
    if (limit === 0) {
        return defaultLimit;
    }
    return limit;
...
exports.default = (function (config) {
    return function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var limit, models, hasMoreModels, cursorModel, cursor, resultModels, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    models = _a.sent();
                    hasMoreModels = models.length > limit;
                    cursorModel = models[models.length - 1];
                    cursor = hasMoreModels
                        ? cursorModel._id + "_" + cursorModel.stored.toISOString()
                        : undefined;
                    resultModels = hasMoreModels ? models.slice(0, models.length - 1) : models;
                    return [4 /*yield*/, getStatementsResult_1.default(config, opts, resultModels)];
                case 2:
                    result = _a.sent();
                    return [2 /*return*/, __assign(__assign({}, result), { cursor: cursor })];
            }
        });
    }); };
});
