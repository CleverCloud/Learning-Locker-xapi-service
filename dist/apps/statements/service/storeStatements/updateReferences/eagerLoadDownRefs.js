...
var groupStatementsById_1 = __importDefault(require("./groupStatementsById"));
var getGroupedDownRefs = function (config, models, client) { return __awaiter(void 0, void 0, void 0, function () {
    var allIds, targetIds, targetStatements, groupedStatements;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                allIds = models.map(function (model) {
                    return model.statement.id;
                });
                targetIds = models.reduce(function (results, model) {
                    if (model.statement.object.objectType === 'StatementRef' &&
                        lodash_1.includes(allIds, model.statement.object.id) // No need to load models that we already have.
                    ) {
                        return __spreadArray(__spreadArray([], results), [model.statement.object.id]);
                    }
                    return results;
                }, []);
            ...
            case 1:
                ...
                return [2 /*return*/, groupedStatements];
        }
    });
}); };
var getGroupedModels = function (models) {
    var statements = models.map(function (model) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, __assign(__assign({}, groupedDownRefs), groupedModels)];
        }
    });
}); });
//# sourceMappingURL=eagerLoadDownRefs.js.map