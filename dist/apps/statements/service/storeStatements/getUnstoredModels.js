...
var modelsConflicts = function (models) {
    return models.reduce(function (_a, model) {
        ...
        if (model.hasGeneratedId) {
            ...
            return {
                modelsMap: modelsMap,
                generatedIdModels: __spreadArray(__spreadArray([], generatedIdModels), [model]),
            };
        }
        ...
        return {
            modelsMap: __assign(__assign({}, modelsMap), (_b = {}, _b[statementId] = model, _b)),
            generatedIdModels: generatedIdModels,
        };
    }, { modelsMap: {}, generatedIdModels: [] });
};
var repoConflicts = function (config, modelsMap, client) { return __awaiter(void 0, void 0, void 0, function () {
    var hashesMap, _a;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, __spreadArray(__spreadArray([], ungeneratedIdModels), conflictRes.generatedIdModels)];
        }
    });
}); });
