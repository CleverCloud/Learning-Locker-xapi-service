...
describe('postStatements', function () {
    ...
    it('should insert statement with proper bypassQueues query param (using alternate request)', function () { return __awaiter(void 0, void 0, void 0, function () {
        var TEST_ID, TEST_CLIENT, expectedCompletedQueues;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    TEST_ID = '1c86d8e9-f325-404f-b3d9-24c451035588';
                    TEST_CLIENT = createClientModel_1.default();
                    expectedCompletedQueues = ['STATEMENT_QUEUE_1', 'STATEMENT_QUEUE_2'];
                    return [4 /*yield*/, supertest
                            .post(constants_2.statementsRoute)
