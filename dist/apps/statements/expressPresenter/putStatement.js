...
exports.default = (function (config) {
    return catchErrors_1.default(config, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var contentType, client, priority, bypassQueues, statementId, _a, body, attachments, body, _b, attachments;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    if (!contentTypePatterns_1.multipartContentTypePattern.test(contentType)) return [3 /*break*/, 3];
                    return [4 /*yield*/, getMultipartStatements_1.default(req)];
                case 2:
                    _a = _c.sent(), body = _a.body, attachments = _a.attachments;
                    return [2 /*return*/, storeStatement_1.default({
                            config: config,
                            priority: priority,
                ...
                case 3:
                    if (!contentTypePatterns_1.jsonContentTypePattern.test(contentType)) return [3 /*break*/, 5];
                    _b = parseJson_1.default;
                    return [4 /*yield*/, stream_to_string_1.default(req)];
                case 4:
                    body = _b.apply(void 0, [_c.sent(), ['body']]);
                    attachments = [];
                    return [2 /*return*/, storeStatement_1.default({
                            config: config,
                            priority: priority,
                ...
                case 5: throw new InvalidContentType_1.default(contentType);
            }
        });
    }); });
});
