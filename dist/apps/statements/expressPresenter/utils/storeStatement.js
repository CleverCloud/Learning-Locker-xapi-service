...
exports.default = (function (_a) {
    var config = _a.config, priority = _a.priority, bypassQueues = _a.bypassQueues, body = _a.body, attachments = _a.attachments, client = _a.client, statementId = _a.statementId, res = _a.res;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    models = [
                        __assign(__assign({}, body), { id: statementId }),
                    ];
                    return [4 /*yield*/, config.service.storeStatements({ priority: priority, bypassQueues: bypassQueues, models: models, attachments: attachments, client: client })];
                case 1:
                    _b.sent();
