...
exports.boundary = 'zzzlearninglockerzzz';
exports.default = (function (jsonResponse, attachments, stream) { return __awaiter(void 0, void 0, void 0, function () {
    var crlf, fullBoundary, stringResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                crlf = '\r\n';
                fullBoundary = crlf + "--" + exports.boundary + crlf;
                ...
                return [4 /*yield*/, Promise.resolve(bluebird_1.reduce(attachments, function (_result, attachment) {
            ...
            case 1:
                _a.sent();
                stream.write("--" + exports.boundary + "--");
                stream.end();
                return [2 /*return*/];
        }
    });
}); });
//# sourceMappingURL=streamStatementsWithAttachments.js.map