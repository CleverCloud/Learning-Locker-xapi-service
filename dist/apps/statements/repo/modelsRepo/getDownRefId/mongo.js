            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        query = __assign({ 'statement.object.objectType': 'StatementRef', 'statement.id': id }, matchesClientOption_1.default(client));
                        queryOptions = {
                            projection: {
                                _id: 0,
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, result.statement.object.id];
                }
            });
        });
    };
