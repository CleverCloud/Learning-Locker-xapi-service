            ...
            switch (_a.label) {
                case 0:
                    ...
                    documents = opts.models.map(function (model) {
                        ...
                        return __assign(__assign({}, model), { organisation: new mongodb_1.ObjectId(model.organisation), lrs_id: new mongodb_1.ObjectId(model.lrs_id), client: new mongodb_1.ObjectId(model.client), statement: statement });
                    });
