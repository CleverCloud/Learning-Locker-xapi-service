...
var factory_1 = __importDefault(require("../utils/mongoAuth/factory"));
...
var TEST_BASIC_TOKEN = "Basic " + btoa_1.default(TEST_BASIC_KEY + ":" + TEST_BASIC_SECRET);
var TEST_ACCESS_TOKEN = '11112222-3333-4444-5555-666677778888';
var TEST_CLIENT = __assign(__assign({}, TEST_CLIENT_MODEL), { _id: new mongodb_1.ObjectId('5988f0f00000000000000123'), api: {
        basic_key: TEST_BASIC_KEY,
        basic_secret: TEST_BASIC_SECRET,
    }, authority: JSON.stringify(TEST_CLIENT_MODEL), organisation: new mongodb_1.ObjectId('5988f0f00000000000000000'), lrs_id: new mongodb_1.ObjectId('5988f0f00000000000000001') });
var TEST_ORG = {
...
describe(__filename, function () {
    ...
    var authRepo = factory_1.default({ db: connection });
    ...
    it('should return a client from the db when basic auth token is valid', function () { return __awaiter(void 0, void 0, void 0, function () {
        var db, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection()];
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, authRepo.getClient({ authToken: TEST_BASIC_TOKEN })];
                case 5:
                    result = _a.sent();
                    assert_1.default.strictEqual(result.client._id, TEST_CLIENT_MODEL._id.toString());
                    return [2 /*return*/];
            }
        });
    }); });
    it('should error when getting without any clients in the DB', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promise = authRepo.getClient({ authToken: TEST_BASIC_TOKEN });
    ...
    it('should return a client from the db when access_token is valid', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    result = _a.sent();
                    assert_1.default.strictEqual(result.client._id, TEST_CLIENT._id.toString());
                    return [2 /*return*/];
            }
        });
    }); });
