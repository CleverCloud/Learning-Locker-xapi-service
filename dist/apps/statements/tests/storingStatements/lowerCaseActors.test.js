...
describe(__filename, function () {
    var service = index_1.default(__assign(__assign({}, config_1.default.statementsService), { enableActorLowerCasing: true, repo: repo_1.default, tracker: tracker_1.default, logger: logger_1.default }));
    ...
    it('should lower case IFIs without sub statements', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    actualStatement = _a.sent();
                    assert_1.default.deepStrictEqual(actualStatement, __assign(__assign({}, actualStatement), expectedStatement));
                    return [2 /*return*/];
            }
        });
    }); });
});
//# sourceMappingURL=lowerCaseActors.test.js.map