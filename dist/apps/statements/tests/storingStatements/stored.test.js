...
describe('store statement stored', function () {
    ...
    it('should generate a stored timestamp when stored is set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    statement = _a.sent();
                    assert_1.default.notStrictEqual(statement.stored, TEST_TIMESTAMP);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should generate a stored timestamp when stored is not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
