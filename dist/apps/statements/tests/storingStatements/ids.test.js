...
describe('store statement ids', function () {
    var service = setup_1.default();
    var storeStatements = storeStatementsInService_1.default(service);
    it('should use existing id when they have an id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ids;
    ...
    it('should generate an id when they have no id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var ids;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([createStatement_1.default()])];
                case 1:
                    ids = _a.sent();
                    assert_1.default.strictEqual(lodash_1.isArray(ids), true);
                    assert_1.default.strictEqual(ids.length, 1);
                    return [2 /*return*/];
            }
        });
    }); });
