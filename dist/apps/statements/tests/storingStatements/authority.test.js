...
describe('store statement authority', function () {
    ...
    var storeStatements = function (statements, authority) {
        return storeAwaitedStatements_1.default(service)({
            models: statements,
            attachments: [],
            client: createClientModel_1.default({ authority: authority }),
        });
    };
    ...
    it('should use the authority option when authority is set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    statement = _a.sent();
                    assert_1.default.strictEqual(statement.authority.mbox, TEST_AUTHORITY.mbox);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should use the authority option when authority is not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([
