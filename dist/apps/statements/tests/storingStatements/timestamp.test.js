...
var TEST_TIMESTAMP = '2017-04-12T15:37:35+00:00';
var TEST_CLIENT = createClientModel_1.default();
describe('store statement timestamp', function () {
    ...
    it('should use existing timestamp when timestamp is set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    statement = _a.sent();
                    assert_1.default.strictEqual(statement.timestamp, TEST_TIMESTAMP);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should generate a timestamp when timestamp is not set', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    statement = _a.sent();
                    assert_1.default.strictEqual(statement.timestamp, statement.stored);
                    return [2 /*return*/];
            }
        });
    }); });
