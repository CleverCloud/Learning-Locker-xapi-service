...
describe('get statements with the same stored value using cursor', function () {
    var service = setup_1.default();
    var storeStatements = storeStatementsInService_1.default(service);
    var statement1 = createStatement_1.default({ id: TEST_ID_1 });
    var statement2 = createStatement_1.default({ id: TEST_ID_2 });
    var statement3 = createStatement_1.default({ id: TEST_ID_3 });
    var statement4 = createStatement_1.default({ id: TEST_ID_4 });
    var statement5 = createStatement_1.default({ id: TEST_ID_5 });
    it('should return correct statements when ascending', function () { return __awaiter(void 0, void 0, void 0, function () {
        var page1Results, page2Results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([statement1, statement2, statement3, statement4, statement5])];
                case 1:
                    _a.sent();
...
//# sourceMappingURL=cursorSameStoredValues.test.js.map