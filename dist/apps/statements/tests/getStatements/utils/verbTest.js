...
exports.default = (function (assertFilteredStatements) {
    ...
    it('should return statements when they match the verb', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, filterStatements([
                        createStatement_1.default({ id: TEST_TARGET_ID, verb: { id: TEST_TARGET_VERB_ID } }),
                        createStatement_1.default({ id: TEST_MISSING_ID, verb: { id: TEST_MISSING_VERB_ID } }),
                    ])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
...
//# sourceMappingURL=verbTest.js.map