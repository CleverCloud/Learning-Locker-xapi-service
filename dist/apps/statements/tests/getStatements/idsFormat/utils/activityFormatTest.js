...
exports.default = (function (createActivityStatement, createIdsActivityStatement) {
    ...
    var assertIdsActivity = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should return the id and objectType without the definition', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertIdsActivity('http://www.example.com/object')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=activityFormatTest.js.map