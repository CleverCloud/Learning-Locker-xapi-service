...
var TEST_VOIDER_ID = '1c86d8e9-f325-404f-b3d9-24c451035583';
var TEST_STATEMENT = createStatement_1.default({ id: TEST_ID });
var TEST_VOIDER = createVoidingStatement_1.default(TEST_ID, TEST_VOIDER_ID);
...
describe('get statements', function () {
    ...
    var assertVoided = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertFilteredStatements_1.default(service)({
    ...
    it('should return only the voider when it is voiding in a following batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should return only the voider when it is voiding in a previous batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should return only the voider when it is voiding earlier in the same batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should return only the voider when it is voiding later in the same batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
//# sourceMappingURL=voiding.test.js.map