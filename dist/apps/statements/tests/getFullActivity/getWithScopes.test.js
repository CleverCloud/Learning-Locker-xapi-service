...
describe('getFullActivity with scopes', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, service.getFullActivity({
                        ...
                        client: testValues_1.TEST_ALLOWED_CLIENT,
                    })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should throw an error when using invalid scopes', function () { return __awaiter(void 0, void 0, void 0, function () {
        var promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promise = service.getFullActivity({
                        activityId: testValues_1.TEST_ACTIVITY_ID,
                        client: testValues_1.TEST_FORBIDDEN_CLIENT,
                    });
