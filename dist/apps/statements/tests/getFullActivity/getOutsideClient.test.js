...
describe('getFullActivity outside client', function () {
    var service = setup_1.default();
    it('should return the activity ID when getting a activity outside the org', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, service.getFullActivity({
                            ...
                            client: testValues_1.TEST_OUTSIDE_ORG_CLIENT,
                        })];
                case 2:
    ...
    it('should return the activity ID when getting a activity outside the store', function () { return __awaiter(void 0, void 0, void 0, function () {
        var statement, fullActivity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, service.getFullActivity({
                            activityId: testValues_1.TEST_ACTIVITY_ID,
                            client: testValues_1.TEST_OUTSIDE_STORE_CLIENT,
                        })];
                case 2:
                    fullActivity = _a.sent();
                    assert_1.default.deepStrictEqual(fullActivity, testValues_1.TEST_BASE_ACTIVITY);
...
//# sourceMappingURL=getOutsideClient.test.js.map