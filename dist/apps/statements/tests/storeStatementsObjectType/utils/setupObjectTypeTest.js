...
exports.default = (function () {
    ...
    var storeStatement = function (statement) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([
                        createStatement_1.default(__assign({ id: TEST_ID }, statement)),
                    ])];
                case 1:
                    _a.sent();
                    return [2 /*return*/, getStatement()];
            }
        });
    }); };
    var assertTypedStatement = function (obj, objectType, objCreator) { return __awaiter(void 0, void 0, void 0, function () {
        var actualStatement, typedStatement, expectedStatement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatement(objCreator(obj))];
                case 1:
                    actualStatement = _a.sent();
                    typedStatement = createStatement_1.default(__assign({ id: TEST_ID }, objCreator(__assign(__assign({}, obj), { objectType: objectType }))));
                    expectedStatement = lodash_1.merge({}, actualStatement, typedStatement);
...
//# sourceMappingURL=setupObjectTypeTest.js.map