...
exports.default = (function (createVerbStatement, createIdsVerbStatement) {
    ...
    var assertIdsVerb = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should return the id without the display', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, assertIdsVerb('http://www.example.com/verb')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=verbFormatTest.js.map