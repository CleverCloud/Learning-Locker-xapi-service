...
describe('get statement', function () {
    ...
    var assertVoided = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    assert_1.default.strictEqual(voidedStatement.id, TEST_ID);
                    return [2 /*return*/];
            }
        });
    }); };
    it('should throw an error when the statement does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should throw an error when the voider is not voided ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should throw an error when the voider does not exist', function () { return __awaiter(void 0, void 0, void 0, function () {
        var promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should void a statement when it is voided in a following batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([TEST_STATEMENT])];
                case 1:
    ...
    it('should void a statement when it is voided in a previous batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should void a statement when it is voided earlier in the same batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should void a statement when it is voided later in the same batch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
