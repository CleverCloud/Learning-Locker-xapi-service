...
describe('store statements with scopes', function () {
    ...
    var testWriteScope = function (clientScopes) { return __awaiter(void 0, void 0, void 0, function () {
        var client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = createClientModel_1.default({ _id: 'test_client_b', scopes: clientScopes });
    ...
    it('should create statements when using xAPI all scope', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should return a statement when using xAPI write statements scope', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should throw an error when using a forbidden write scope', function () { return __awaiter(void 0, void 0, void 0, function () {
        var client, promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should create statements using default configuration of priority and bypass queues', function () { return __awaiter(void 0, void 0, void 0, function () {
        var client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
