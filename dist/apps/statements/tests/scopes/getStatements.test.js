...
describe('get statements with scopes', function () {
    ...
    var testReadAllScope = function (clientScopes) { return __awaiter(void 0, void 0, void 0, function () {
        var client, result, actualIds, expectedIds;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = createClientModel_1.default({ _id: '59891b200000000000000000', scopes: clientScopes });
                    return [4 /*yield*/, storeStatements([TEST_STATEMENT])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, service.getStatements({ client: client })];
                case 2:
                    result = _a.sent();
                    actualIds = result.statements.map(function (statement) {
                        return statement.id;
                    });
                    expectedIds = [TEST_ID];
                    assert_1.default.deepStrictEqual(actualIds, expectedIds);
                    return [2 /*return*/];
            }
        });
    }); };
    it('should return no statements when using a different client with read mine scope', function () { return __awaiter(void 0, void 0, void 0, function () {
        var client, actualStatements;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    assert_1.default.deepStrictEqual(actualStatements, []);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    it('should throw an error when using a forbidden read scope', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    promise = service.getStatements({ client: client });
