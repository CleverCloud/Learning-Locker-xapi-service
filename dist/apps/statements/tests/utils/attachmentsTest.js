...
var TEST_FILE_URL_ATTACHMENT = createAttachment_1.default('A', 'http://www.example.com');
exports.default = (function (service, assertAttachments, createStatement) {
    ...
    it('should return an attachment when it is referenced once', function () { return __awaiter(void 0, void 0, void 0, function () {
        var contentA, testAttachmentA, testAttachmentModelA, testStatement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contentA = uuid_1.v4();
                    testAttachmentA = createAttachment_1.default(contentA);
                    testAttachmentModelA = createAttachmentModel_1.default(contentA);
                    testStatement = createStatement([testAttachmentA], TEST_ID_1);
    ...
    it('should return an attachment once when it is referenced twice and attached once', function () { return __awaiter(void 0, void 0, void 0, function () {
        var contentA, testAttachmentA, testAttachmentModelA, testStatement1, testStatement2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    contentA = uuid_1.v4();
                    testAttachmentA = createAttachment_1.default(contentA);
                    testAttachmentModelA = createAttachmentModel_1.default(contentA);
                    testStatement1 = createStatement([testAttachmentA], TEST_ID_1);
                    testStatement2 = createStatement([testAttachmentA], TEST_ID_2);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    testAttachmentA = createAttachment_1.default(contentA);
                    testAttachmentModelA = createAttachmentModel_1.default(contentA);
                    testStatement = createStatement([testAttachmentA, testAttachmentA], TEST_ID_1);
                    return [4 /*yield*/, storeStatements([testStatement], [testAttachmentModelA])];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, assertAttachments([TEST_ID_1], [testAttachmentModelA])];
