...
var translator = __assign({ conflictError: function () {
        return 'Get the profile to retrieve the Etag, then set the If-Match header to the Etag';
    }, expiredClientError: function () { return "Your organisation has expired"; }, ifMatchError: function () {
        return 'IfMatch does not match Etag because a modification has been made since it was retrieved';
