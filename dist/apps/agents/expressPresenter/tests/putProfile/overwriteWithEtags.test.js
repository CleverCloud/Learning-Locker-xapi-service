...
describe('expressPresenter.putProfile with etags', function () {
    ...
    it('should throw precondition error when using an incorrect ifNoneMatch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, overwriteProfile_1.default().set('If-None-Match', '*').expect(http_status_codes_1.StatusCodes.PRECONDITION_FAILED)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw conflict error when not using ifMatch or ifNoneMatch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, overwriteProfile_1.default().unset('If-None-Match').expect(http_status_codes_1.StatusCodes.CONFLICT)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should throw missing etags error when not using ifMatch and ifNoneMatch', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, overwriteProfile_1.default().unset('If-None-Match').expect(http_status_codes_1.StatusCodes.BAD_REQUEST)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
