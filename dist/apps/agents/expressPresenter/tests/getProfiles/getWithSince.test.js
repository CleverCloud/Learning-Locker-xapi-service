        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    timestamp = new Date();
                    return [4 /*yield*/, getProfiles_1.default({ since: timestamp.toISOString() }).expect(http_status_codes_1.StatusCodes.OK, [])];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, getProfiles_1.default({
                        ...
                        }).expect(http_status_codes_1.StatusCodes.OK, [testValues_1.TEST_PROFILE_ID])];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
