...
describe(__filename, function () {
    ...
    it('should not error when using a charset for JSON ', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest
                        .post(constants_1.route + "/profile")
                        .set('Content-Type', testValues_1.JSON_CONTENT_TYPE + "; charset=UTF-8")
    ...
    it('should not error when using a charset for alternate requests ', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest
                        .post(constants_1.route + "/profile")
                        .set('Content-Type', testValues_1.ALTERNATE_CONTENT_TYPE + "; charset=UTF-8")
                        .set('X-Experience-API-Version', constants_1.xapiHeaderVersion)
                        .query({
                        method: 'POST',
                    })
                        ...
                        'If-None-Match': '*',
                        agent: JSON.stringify(testValues_1.TEST_MBOX_AGENT),
                        content: testValues_1.TEST_OBJECT_CONTENT,
                        profileId: testValues_1.TEST_PROFILE_ID,
                    })
                        .expect(http_status_codes_1.StatusCodes.NO_CONTENT)];
                case 1:
