...
describe('expressPresenter using the alternate request syntax', function () {
    var supertest = setup_1.default().supertest;
    it('should return error when using an invalid method', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should not error when using an invalid content type', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supertest
                        .post(constants_1.route + "/profile")
