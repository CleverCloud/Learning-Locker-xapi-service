...
describe('getProfile with existing state', function () {
    setup_1.default();
    var assertGetProfile = function (result, content, contentType) { return __awaiter(void 0, void 0, void 0, function () {
        var actualContent;
