...
exports.default = (function (config) {
    return __assign({ deleteProfileContent: deleteProfileContent_1.default(config), getProfileContent: getProfileContent_1.default(config), storeProfileContent: storeProfileContent_1.default(config) }, fsRepo_1.default(config));
});
