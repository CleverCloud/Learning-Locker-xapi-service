...
exports.default = (function (_a) {
    var query = _a.query, config = _a.config, headers = _a.headers, res = _a.res, content = _a.content;
    return __awaiter(void 0, void 0, void 0, function () {
        var client, contentType, ifMatch, ifNoneMatch, activityId, profileId;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ifNoneMatch = getEtag_1.default(lodash_1.get(headers, 'if-none-match'));
                    ...
                    return [4 /*yield*/, config.service.overwriteProfile({
...
//# sourceMappingURL=overwriteProfileWithService.js.map