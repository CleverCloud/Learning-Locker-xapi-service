...
exports.default = (function (config) {
    return function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var profileDir, filePath, blobUrl, blockBlobUrl, contentStreamPromise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    profileDir = getStorageDir_1.default({
                    ...
                    return [4 /*yield*/, storage_blob_1.uploadStreamToBlockBlob(storage_blob_1.Aborter.none, opts.content, blockBlobUrl, BUFFER_SIZE, MAX_BUFFERS)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, contentStreamPromise];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
