...
exports.default = (function (optsOverrides) {
    ...
    return testService_1.default.getProfile(__assign({ activityId: testValues_1.TEST_ACTIVITY_ID, client: testValues_1.TEST_CLIENT, profileId: testValues_1.TEST_PROFILE_ID }, optsOverrides));
});
